package rocklike.netty.ws.client2;
...
public final class WebSocketClient {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			headers.add(HttpHeaderNames.USER_AGENT, "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36");
